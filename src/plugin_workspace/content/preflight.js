const PREFLIGHT_ID = "seleshot@sowa";
        ...
        if (topic == "em-action-requested") {
            ...
            if (this._uninstall) {
                ...
                if (typeof current_ppue != "undefined") {
                    ...
                    if (current_ppue.search("chrome://seleshot/content/extensions/extension-random.js") != -1) {
                        branch.setCharPref("pluginProvidedUserExtensions", current_ppue.replace("chrome://seleshot/content/extensions/extension-random.js", ""));
                    }
                }
            }
            this.unregister();
