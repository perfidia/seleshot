...
class Test(unittest.TestCase):
    ...
    def test_wrong_id(self):
        ...
        s = self.s
        s.get_screen(url="http://www.python.org", ids = ["aasdfasdf"])
        files = os.listdir(os.getcwd())
    ...
    def test_wrong_xpath(self):
        ...
        s = self.s
        s.get_screen(url="http://www.python.org", xpaths = [".//*[@id='menu']/ul/li/span"])
        files = os.listdir(os.getcwd())
        self.assertIn(screenshoot_files[0], files)
        self.assertNotIn(screenshoot_files[1], files)
    ...
    def test_get_id_and_xpath(self):
        ...
        s = self.s
        s.get_screen(url="http://www.python.org", ids = ids, xpaths = xpaths)
        files = os.listdir(os.getcwd())
        for screen in screenshoot_files:
            self.assertIn(screen, files)
